...
+ (TRSideMenu *)menuWithNavigationController:(UINavigationController *)controller
                      leftSideMenuController:(id)leftMenuController
                     rightSideMenuController:(id)rightMenuController {
    MFSideMenuPanMode panMode = MFSideMenuPanModeNavigationBar|MFSideMenuPanModeNavigationController;
    return [TRSideMenu menuWithNavigationController:controller
...
+ (TRSideMenu *) menuWithNavigationController:(UINavigationController *)controller
    ...
    TRSideMenu *menu = [[TRSideMenu alloc] init];
